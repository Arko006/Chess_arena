...
import {
  ...
  Play, Pause, Trophy, Share2, RefreshCw, ChevronRight, MessageCircle, Mail
} from 'lucide-react';
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            {activeMatches.map((match) => (
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-2 pt-3 border-t border-gray-800">
                  <button
                    onClick={() => setSelectedMatchForShare(match)}
                    className="py-2.5 px-3 rounded-xl bg-gradient-to-r from-emerald-600/20 to-teal-600/20 hover:from-emerald-600/30 hover:to-teal-600/30 text-emerald-300 border border-emerald-500/40 font-bold text-xs flex items-center justify-center gap-1.5 transition-all hover:scale-[1.02]"
                  ...
                  <Link
                    ...
                    className="py-2.5 px-3 rounded-xl bg-indigo-600/20 hover:bg-indigo-600/30 text-indigo-300 border border-indigo-500/30 font-bold text-xs flex items-center justify-center gap-1.5 transition-colors"
                  >
              ...
              <div className="space-y-4">
                ...
                <div className="bg-[#1a1f2e] border border-gray-700 rounded-xl p-4">
                  ...
                  <div className="flex items-center gap-2 mt-2">
                    <button
                      onClick={() => {
                        const msg = `♟️ ChessArena: Hello ${whitePlayerName}, your WHITE seat link vs ${blackPlayerName} is:\n${newMatchLinks.white.url}`;
                        window.open(`https://api.whatsapp.com/send?text=${encodeURIComponent(msg)}`, '_blank');
                      }}
                      className="px-2.5 py-1 rounded-lg bg-emerald-950/40 hover:bg-emerald-900/60 text-emerald-300 border border-emerald-800/50 text-[11px] font-semibold transition-colors flex items-center gap-1"
                    >
                    ...
                    <button
                      onClick={() => {
                        const msg = `♟️ ChessArena: Hello ${whitePlayerName}, your WHITE seat link vs ${blackPlayerName} is:\n${newMatchLinks.white.url}`;
                        window.location.href = `mailto:?subject=${encodeURIComponent(`ChessArena: White Link vs ${blackPlayerName}`)}&body=${encodeURIComponent(msg)}`;
                      }}
                      className="px-2.5 py-1 rounded-lg bg-gray-800 hover:bg-gray-700 text-gray-300 border border-gray-700 text-[11px] font-semibold transition-colors flex items-center gap-1"
                    >
                ...
                <div className="bg-[#1a1f2e] border border-gray-700 rounded-xl p-4">
                  <div className="flex items-center justify-between mb-1.5">
                    <span className="text-xs font-bold text-white flex items-center gap-1.5">
                      ...
                      Black Player Link ({blackPlayerName}):
                    </span>
                    <button
                  ...
                  <div className="flex items-center gap-2 mt-2">
                    <button
                      onClick={() => {
                        const msg = `♟️ ChessArena: Hello ${blackPlayerName}, your BLACK seat link vs ${whitePlayerName} is:\n${newMatchLinks.black.url}`;
                        window.open(`https://api.whatsapp.com/send?text=${encodeURIComponent(msg)}`, '_blank');
                      }}
                      className="px-2.5 py-1 rounded-lg bg-emerald-950/40 hover:bg-emerald-900/60 text-emerald-300 border border-emerald-800/50 text-[11px] font-semibold transition-colors flex items-center gap-1"
                    >
                    ...
                    <button
                      onClick={() => {
                        const msg = `♟️ ChessArena: Hello ${blackPlayerName}, your BLACK seat link vs ${whitePlayerName} is:\n${newMatchLinks.black.url}`;
                        window.location.href = `mailto:?subject=${encodeURIComponent(`ChessArena: Black Link vs ${whitePlayerName}`)}&body=${encodeURIComponent(msg)}`;
                      }}
                      className="px-2.5 py-1 rounded-lg bg-gray-800 hover:bg-gray-700 text-gray-300 border border-gray-700 text-[11px] font-semibold transition-colors flex items-center gap-1"
                    >
                      <Mail className="w-3 h-3" />
      ...
      <ShareMatchLinksModal
        ...
        matchSummary={{
          ...
          tournamentName: selectedMatchForShare?.tournament?.name,
          timeControl: selectedMatchForShare?.timeControl,
        }}
      />
    </div>
  );
