          ...
          {isArbiter && (
            <>
              ...
              <button
                ...
                className="px-4 py-2.5 rounded-xl bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-500 hover:to-purple-500 text-white font-bold text-xs shadow-lg shadow-indigo-600/30 transition-all flex items-center gap-1.5 disabled:opacity-50"
              >
              ...
              <div className="space-y-4">
                {roundMatches.map((m: any) => {
                  ...
                  return (
                    <div
                      key={m.id}
                      className="bg-[#141824] border border-gray-800 hover:border-gray-700 rounded-2xl p-5 shadow-xl transition-all"
                    >
